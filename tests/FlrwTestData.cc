...
const double FlrwTestData::age_table[][5][3] =
{
 ...
 {{11.9536908857156, 0, 1e-4}, // OV_2
  {10.2360738195798, 0.1, 1e-4},
  {3.97056489847142, 1, 1e-5},
  {0.294473173870961, 10, 1e-6},
  {0.0104975552149488, 100, 1e-7}},
