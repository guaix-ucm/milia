 ...
 * It is based on the paper <a href="http://xxx.unizar.es/abs/astro-ph/9905116">%astro-ph/9905116</a> for the relations between distances.
 * The age is computed from <a href="http://xxx.unizar.es/abs/astro-ph/0003463">%astro-ph/0003463</a> with elliptical functions.
 * Distances are computed from the luminosity distance using<a href="http://xxx.unizar.es/abs/astro-ph/0002334">%astro-ph/0002334</a> without inhomogeneities.
 * 
 * 
 */
class flrw {
public:
	 ...
	 * \f[
	 * dc(z)=\frac{1}{H_0}\int_0^z \frac{dt}{\sqrt{\Omega_M(1+t)^3+\Omega_k(1+t)^2+\Omega_{\Lambda}}}
	 * \f]
	 * 
	 */
...
private:
	 ...
	 */
	static bool is_there_big_bang(double matter, double lambda, double b);
